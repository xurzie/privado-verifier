...
export declare class JsonLDLoader {
    loadDocument(url: string, redirects?: string[]): Promise<RemoteDocument>;
}
...
export declare const getJsonLdDocLoader: (ipfsNodeURL?: string | undefined, ipfsGatewayURL?: string | undefined) => DocumentLoader;
//# sourceMappingURL=jsonld-loader.d.ts.map