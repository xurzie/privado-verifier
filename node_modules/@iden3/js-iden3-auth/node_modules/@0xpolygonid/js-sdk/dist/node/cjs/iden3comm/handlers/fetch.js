...
class FetchHandler extends message_handler_1.AbstractMessageHandler {
    ...
    async handle(message, ctx) {
        switch (message.type) {
            ...
            case constants_2.PROTOCOL_MESSAGE_TYPE.CREDENTIAL_ONCHAIN_OFFER_MESSAGE_TYPE: {
    ...
    async handleOnchainOfferMessage(offerMessage) {
        ...
        for (const credentialInfo of offerMessage.body.credentials) {
            const issuerDID = js_iden3_core_1.DID.parse(offerMessage.from);
            const userDID = js_iden3_core_1.DID.parse(offerMessage.to);
    ...
    async handleCredentialOffer(offer, opts) {
        ...
        if (!opts?.allowExpiredMessages) {
            (0, common_1.verifyExpiresTime)(offerMessage);
        }
    ...
    async handleOnchainOffer(offer) {
        const offerMessage = await FetchHandler.unpackMessage(this._packerMgr, offer, constants_2.PROTOCOL_MESSAGE_TYPE.CREDENTIAL_ONCHAIN_OFFER_MESSAGE_TYPE);
    ...
    async handleCredentialFetchRequest(envelope, opts) {
        ...
        if (!opts?.allowExpiredMessages) {
            (0, common_1.verifyExpiresTime)(msgRequest);
        }
    ...
    async handleIssuanceResponseMessage(envelop, opts) {
        ...
        if (!opts?.allowExpiredMessages) {
            (0, common_1.verifyExpiresTime)(issuanceMsg);
        }
